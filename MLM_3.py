...
df_clean = df_double.dropna(subset=['fitness', 'PLL'])
...
plt.ylabel('ESM-2 Pseudo-Log-Likelihood (Double Mutation)', fontsize=12)
...
plt.tight_layout()
plt.savefig("pll_correlation_plot_double_mutation.png", dpi=300)
