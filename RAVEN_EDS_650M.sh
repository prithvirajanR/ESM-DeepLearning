#!/bin/bash
#SBATCH --job-name=EDS_650M
#SBATCH --output=%j_EDS_650M.out
#SBATCH --error=%j_EDS_650M.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OUTPUT_FILE="results/${INPUT_FILE%.*}_ESM2_650M_EDS_predictions.csv"

# 3. Execution
echo "Running EDS with ESM2 650M..."
