...
echo "ðŸ¦… Starting Interactive Test on Raven..."
...
echo "ðŸ“‚ Working Directory: $MY_PROJECT_DIR"
...
echo "ðŸ§ª Running Validation (Pipeline Verifier)..."
python -m src.verify_pipeline

# 4. dry-run of main script
echo "ðŸ§ª Running Dry-Run of Batch Scoring (2 samples)..."
...
echo "âœ… Test Complete. If you see 'Done!', your code is ready."
